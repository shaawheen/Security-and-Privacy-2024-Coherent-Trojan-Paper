 ...
 * @brief RT-Bench compatible quicksort benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/kernel/quicksort/quicksort.c for the exact license(s).
 *
