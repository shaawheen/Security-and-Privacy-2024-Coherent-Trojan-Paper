 ...
 * @brief RT-Bench compatible sha benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/kernel/sha/sha.c for the exact license(s).
 *
