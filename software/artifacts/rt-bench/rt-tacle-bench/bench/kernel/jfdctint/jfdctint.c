/**
 * @file jfdctint.c
 * @defgroup jfdctint Jfdctint
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible jfdctint benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/kernel/jfdctint/jfdctint.c for the exact license(s).
 *
