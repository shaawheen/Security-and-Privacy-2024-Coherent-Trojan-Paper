/**
 * @file matrix1.c
 * @defgroup matrix1 Matrix1
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible matrix1 benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/kernel/matrix1/matrix1.c for the exact license(s).
 *
