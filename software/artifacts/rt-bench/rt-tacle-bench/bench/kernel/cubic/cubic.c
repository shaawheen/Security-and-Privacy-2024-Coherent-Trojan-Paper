 ...
 * @brief RT-Bench compatible cubic benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/kernel/cubic/cubic.c for the exact license(s).
 *
