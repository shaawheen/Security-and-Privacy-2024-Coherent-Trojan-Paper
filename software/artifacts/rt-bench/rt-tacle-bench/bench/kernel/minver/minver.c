/**
 * @file minver.c
 * @defgroup minver Minver
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible minver benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/kernel/minver/minver.c for the exact license(s).
 *
