 ...
 * @brief RT-Bench compatible lms benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/kernel/lms/lms.c for the exact license(s).
 *
