 ...
 * @brief RT-Bench compatible pm benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/kernel/pm/pm.c for the exact license(s).
 *
