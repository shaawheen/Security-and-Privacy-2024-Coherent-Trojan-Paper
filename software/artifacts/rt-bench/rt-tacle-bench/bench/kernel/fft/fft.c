 ...
 * @brief RT-Bench compatible fft benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/kernel/fft/fft.c for the exact license(s).
 *
...
{
  // @todo: check if output/result cannot be written in a second array
