 ...
 * @brief RT-Bench compatible Test3 benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/test/test3/test3.c for the exact license(s).
 *
