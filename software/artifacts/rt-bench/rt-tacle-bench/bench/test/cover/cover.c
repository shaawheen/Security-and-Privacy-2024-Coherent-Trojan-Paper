/**
 @file cover.c
 * @defgroup cover Cover
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible cover benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/test/cover/cover.c for the exact license(s).
 *
