/**
 * @file fmref.c
 * @defgroup fmref Fmref
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible fmref benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/sequential/fmref/fmref.c for the exact license(s).
 *
