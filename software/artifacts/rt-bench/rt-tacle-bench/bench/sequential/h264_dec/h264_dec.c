/**
 * @file h264_dec.c
 * @defgroup h264_dec H264_dec
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible h264_dec benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/sequential/h264_dec/h264_dec.c for the exact license(s).
 *
