/**
 * @file gsm_dec.c
 * @defgroup gsm_dec Gsm_dec
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible gsm_dec benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/sequential/gsm_dec/gsm_dec.c for the exact license(s).
 *
  ...
  @copyright see the accompanying COPYRIGHT file
