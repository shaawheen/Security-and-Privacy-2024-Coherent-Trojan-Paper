/**
 * @file huff_dec.c
 * @defgroup huff_dec Huff_dec
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible huff_dec benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/sequential/huff_dec/huff_dec.c for the exact license(s).
 *
