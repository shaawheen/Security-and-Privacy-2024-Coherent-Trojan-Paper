 ...
 * @defgroup cjpeg_transupp Cjpeg_transupp
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible cjpeg_transupp benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/sequential/cjpeg_transupp/cjpeg_transupp.c for the exact license(s).
 *
