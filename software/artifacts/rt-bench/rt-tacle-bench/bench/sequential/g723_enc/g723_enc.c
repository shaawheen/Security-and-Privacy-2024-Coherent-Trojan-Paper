/**
 * @file g723_enc.c
 * @defgroup g723_enc G723_enc
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible g723_enc benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/sequential/g723_enc/g723_enc.c for the exact license(s).
 *
    ...
    @copyright "Unrestricted use" (see license.txt)
