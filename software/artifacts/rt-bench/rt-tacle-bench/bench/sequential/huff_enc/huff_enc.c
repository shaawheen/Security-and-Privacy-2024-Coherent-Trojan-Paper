/**
 * @file huff_enc.c
 * @defgroup huff_enc Huff_enc
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible huff_enc benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/sequential/huff_enc/huff_enc.c for the exact license(s).
 *
