/**
 * @file audiobeam.c
 * @defgroup audiobeam Audiobeam
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible audiobeam benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/sequential/audiobeam/audiobeam.c for the exact license(s).
 *
