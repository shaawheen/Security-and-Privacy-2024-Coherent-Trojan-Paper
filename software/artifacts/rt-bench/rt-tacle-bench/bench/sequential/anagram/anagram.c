/**
 * @file anagram.c
 * @defgroup anagram Anagram
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible anagram benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/sequential/anagram/anagram.c for the exact license(s).
 *
