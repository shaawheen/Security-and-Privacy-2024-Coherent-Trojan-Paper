/**
 * @file mpeg2.c
 * @defgroup mpeg2 Mpeg2
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible mpeg2 benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/sequential/mpeg2/mpeg2.c for the exact license(s).
 *
  ...
  @copyright See the following disclaimer from the original source codes.
