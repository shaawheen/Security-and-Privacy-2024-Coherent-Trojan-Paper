 ...
 * @brief RT-Bench compatible ndes benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/sequential/ndes/ndes.c for the exact license(s).
 *
