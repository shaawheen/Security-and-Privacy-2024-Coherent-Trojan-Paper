/**
 * @file adpcm_dec.c
 * @defgroup adpcm_dec Adpcm_dec
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible adpcm_dec benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/sequential/adpcm_dec/adpcm_dec.c for the exact license(s).
 *
