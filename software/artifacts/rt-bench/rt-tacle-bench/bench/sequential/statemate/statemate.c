/**
 * @file statemate.c
 * @defgroup statemate Statemate
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible statemate benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/sequential/statemate/statemate.c for the exact license(s).
 *
