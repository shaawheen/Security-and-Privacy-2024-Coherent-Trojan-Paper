/**
 * @file susan.c
 * @defgroup susan Susan
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible susan benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/sequential/susan/susan.c for the exact license(s).
 *
