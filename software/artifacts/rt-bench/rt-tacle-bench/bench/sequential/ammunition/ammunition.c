/**
 * @file ammunition.c
 * @defgroup ammunition Ammunition
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible ammunition benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/sequential/ammunition/ammunition.c for the exact license(s).
 *
