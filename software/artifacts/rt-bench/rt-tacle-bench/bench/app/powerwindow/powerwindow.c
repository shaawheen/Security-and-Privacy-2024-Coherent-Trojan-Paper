/**
 * @file powerwindow.c
 * @defgroup powerwindow Powerwindow
 * @ingroup rt-tacle-bench
 * @brief RT-Bench compatible powerwindow benchmark from TACle Bench.
 * @details
 ...
 * This header was generated automatically, please consult the code at bench/app/powerwindow/powerwindow.c for the exact license(s).
 *
