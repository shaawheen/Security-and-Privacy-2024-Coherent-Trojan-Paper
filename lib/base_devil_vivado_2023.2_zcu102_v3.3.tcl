...
################################################################
# This is a generated script based on design: base_devil
#
...
proc create_root_design { parentCell } {
  ...
  set byte_writer_0 [ create_bd_cell -type ip -vlnv user.org:user:byte_writer:1.0 byte_writer_0 ]
...
\
  ...
  # Create port connections
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins AXI_PerfectTranslator_0/m00_axi_aresetn] [get_bd_pins AXI_PerfectTranslator_0/s00_axi_aresetn] [get_bd_pins byte_writer_0/axi_aresetn] [get_bd_pins byte_writer_0/config_axi_aresetn] [get_bd_pins devil_ip/ace_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins vio_0/probe_out0] [get_bd_pins byte_writer_0/axi_init_axi_txn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins AXI_PerfectTranslator_0/m00_axi_aclk] [get_bd_pins AXI_PerfectTranslator_0/s00_axi_aclk] [get_bd_pins byte_writer_0/axi_aclk] [get_bd_pins byte_writer_0/config_axi_aclk] [get_bd_pins devil_ip/ace_aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins vio_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/sacefpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  ...
  assign_bd_address -offset 0x80010000 -range 0x00001000 -with_name SEG_backstabber_0_reg0_1 -target_address_space [get_bd_addr_spaces byte_writer_0/axi] [get_bd_addr_segs devil_ip/backstabber_0/s01_axi/reg0] -force
  ...
  assign_bd_address -offset 0x80010000 -range 0x00001000 -with_name SEG_backstabber_0_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs devil_ip/backstabber_0/s01_axi/reg0] -force
