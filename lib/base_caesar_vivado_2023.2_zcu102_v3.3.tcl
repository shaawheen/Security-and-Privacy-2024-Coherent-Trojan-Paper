...
################################################################
# This is a generated script based on design: base_caesar
#
...
user.org:user:backstabber:1.0\
user.org:user:AXI_PerfectTranslator:1.0\
...
\
  ...
  set backstabber_0 [ create_bd_cell -type ip -vlnv user.org:user:backstabber:1.0 backstabber_0 ]
  ...
  set_property CONFIG.C_M00_AXI_ID_WIDTH {6} $AXI_PerfectTranslator_0
  ...
  set_property -dict [list \
    ...
    CONFIG.C_SLOT_1_INTF_TYPE {xilinx.com:interface:acemm_rtl:1.0} \
    ...
    CONFIG.C_SLOT_3_MAX_RD_BURSTS {16} \
    CONFIG.C_SLOT_3_MAX_WR_BURSTS {16} \
    ...
    CONFIG.C_SLOT_4_MAX_RD_BURSTS {16} \
    CONFIG.C_SLOT_4_MAX_WR_BURSTS {16} \
  ] $system_ila_0
...
connect_bd_intf_net -intf_net [get_bd_intf_nets AXI_PerfectTranslator_0_M00_AXI] [get_bd_intf_pins AXI_PerfectTranslator_0/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets AXI_PerfectTranslator_0_M00_AXI]
  connect_bd_intf_net -intf_net backstabber_0_acemm_1 [get_bd_intf_pins backstabber_0/acemm_1] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_ACE_FPD]
connect_bd_intf_net -intf_net [get_bd_intf_nets backstabber_0_acemm_1] [get_bd_intf_pins backstabber_0/acemm_1] [get_bd_intf_pins system_ila_0/SLOT_1_ACEMM]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets backstabber_0_acemm_1]
  connect_bd_intf_net -intf_net backstabber_0_m00_axi [get_bd_intf_pins AXI_PerfectTranslator_0/S00_AXI] [get_bd_intf_pins backstabber_0/m00_axi]
connect_bd_intf_net -intf_net [get_bd_intf_nets backstabber_0_m00_axi] [get_bd_intf_pins AXI_PerfectTranslator_0/S00_AXI] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets backstabber_0_m00_axi]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD] [get_bd_intf_pins backstabber_0/s00_axi]
connect_bd_intf_net -intf_net [get_bd_intf_nets zynq_ultra_ps_e_0_M_AXI_HPM0_FPD] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD] [get_bd_intf_pins system_ila_0/SLOT_3_AXI]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_LPD [get_bd_intf_pins backstabber_0/config_axi] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_LPD]
connect_bd_intf_net -intf_net [get_bd_intf_nets zynq_ultra_ps_e_0_M_AXI_HPM0_LPD] [get_bd_intf_pins backstabber_0/config_axi] [get_bd_intf_pins system_ila_0/SLOT_4_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets zynq_ultra_ps_e_0_M_AXI_HPM0_LPD]

  # Create port connections
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins AXI_PerfectTranslator_0/m00_axi_aresetn] [get_bd_pins AXI_PerfectTranslator_0/s00_axi_aresetn] [get_bd_pins backstabber_0/m00_axi_aresetn] [get_bd_pins backstabber_0/ace_aresetn] [get_bd_pins backstabber_0/config_axi_aresetn] [get_bd_pins backstabber_0/s00_axi_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/sacefpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins AXI_PerfectTranslator_0/m00_axi_aclk] [get_bd_pins AXI_PerfectTranslator_0/s00_axi_aclk] [get_bd_pins backstabber_0/m00_axi_aclk] [get_bd_pins backstabber_0/ace_aclk] [get_bd_pins backstabber_0/config_axi_aclk] [get_bd_pins backstabber_0/s00_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins system_ila_0/clk]
  ...
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs backstabber_0/config_axi/Reg] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -with_name SEG_backstabber_0_Reg_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs backstabber_0/s00_axi/Reg] -force
