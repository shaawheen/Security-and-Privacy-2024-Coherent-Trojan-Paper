...
################################################################
# This is a generated script based on design: base_backstabbing
#
...
# source base_backstabbing_script.tcl
...
set design_name base_backstabbing
...
\
  ...
  # Create instance: silent_spy_0, and set properties
  set silent_spy_0 [ create_bd_cell -type ip -vlnv user.org:user:silent_spy:1.0 silent_spy_0 ]
  set_property CONFIG.C_M00_AXI_ID_WIDTH {6} $silent_spy_0
  ...
  connect_bd_intf_net -intf_net silent_spy_0_acemm_1 [get_bd_intf_pins silent_spy_0/acemm_1] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_ACE_FPD]
connect_bd_intf_net -intf_net [get_bd_intf_nets silent_spy_0_acemm_1] [get_bd_intf_pins silent_spy_0/acemm_1] [get_bd_intf_pins system_ila_0/SLOT_0_ACEMM]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets silent_spy_0_acemm_1]
  connect_bd_intf_net -intf_net silent_spy_0_m00_axi [get_bd_intf_pins silent_spy_0/m00_axi] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_LPD [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_LPD] [get_bd_intf_pins silent_spy_0/config_axi]
connect_bd_intf_net -intf_net [get_bd_intf_nets zynq_ultra_ps_e_0_M_AXI_HPM0_LPD] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_LPD] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets zynq_ultra_ps_e_0_M_AXI_HPM0_LPD]

  # Create port connections
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins silent_spy_0/ace_aresetn] [get_bd_pins silent_spy_0/config_axi_aresetn] [get_bd_pins silent_spy_0/m00_axi_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/sacefpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins silent_spy_0/ace_aclk] [get_bd_pins silent_spy_0/config_axi_aclk] [get_bd_pins silent_spy_0/m00_axi_aclk] [get_bd_pins system_ila_0/clk]
  ...
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs silent_spy_0/config_axi/Reg] -force
