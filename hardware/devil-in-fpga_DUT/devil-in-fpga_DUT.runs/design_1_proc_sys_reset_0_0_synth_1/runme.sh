...
HD_PWD='/home/cris/Documents/0_Projects/MancusoCollab/devil-in-the-fpga/hardware/devil-in-fpga_DUT/devil-in-fpga_DUT.runs/design_1_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
